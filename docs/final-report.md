...
- [1. Abstract](#1-abstract)
  - [1.1. Challenges and achievement](#11-challenges-and-achievement)
- [2. Architecture](#2-architecture)
  - [2.1. Motivation](#21-motivation)
  - [2.2. System components](#22-system-components)
  - [2.3. Running the project](#23-running-the-project)
  - [2.4. Run the project in developer mode](#24-run-the-project-in-developer-mode)
- [3. Implementation and challenges](#3-implementation-and-challenges)
  - [3.1. Finding dataset for streaming experiment](#31-finding-dataset-for-streaming-experiment)
    - [3.1.1. XETRA](#311-xetra)
    - [3.1.2. EUREX](#312-eurex)
- [4. Frontend Application](#4-frontend-application)
  - [4.1. Screenshots](#41-screenshots)
  - [4.2. Frontend - Important links](#42-frontend---important-links)
- [5. Backend Application](#5-backend-application)
  - [5.1. Implemented endpoints](#51-implemented-endpoints)
  - [5.2. NPM scripts](#52-npm-scripts)
  - [5.3. Backend - Important links](#53-backend---important-links)
- [6. Kafka Cluster](#6-kafka-cluster)
  - [6.1. Kafka - Important links](#61-kafka---important-links)
- [7. Spark Application](#7-spark-application)
  - [7.1. Dockerization](#71-dockerization)
  - [7.2. Commands for development](#72-commands-for-development)
  - [7.3. Spark - Important links](#73-spark---important-links)
- [8. Appendix 1 - Original project proposal](#8-appendix-1---original-project-proposal)
  - [8.1. Problem to solve](#81-problem-to-solve)
  - [8.2. Milestones](#82-milestones)
    - [8.2.1. Introduction and fixing the data set, setup data stream using sample data (3 weeks)](#821-introduction-and-fixing-the-data-set-setup-data-stream-using-sample-data-3-weeks)
    - [8.2.2. Apache Kafka setup (3 weeks)](#822-apache-kafka-setup-3-weeks)
    - [8.2.3. Apache Spark setup (3 weeks)](#823-apache-spark-setup-3-weeks)
    - [8.2.4. Client application (2 weeks)](#824-client-application-2-weeks)
    - [8.2.5. Documentation and presentation (1 week)](#825-documentation-and-presentation-1-week)
    - [8.2.6. Suggested technologies](#826-suggested-technologies)
- [9. Appendix 2 - Node.js Streaming](#9-appendix-2---nodejs-streaming)
  - [9.1. A Node.js experiment about Streaming: Reading CSV file, transforming records to JavaScript Objects](#91-a-nodejs-experiment-about-streaming-reading-csv-file-transforming-records-to-javascript-objects)
